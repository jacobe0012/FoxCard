...
public sealed partial class tag_func :  Bright.Config.BeanBase 
{
    ...
    public tag_func(int id, int tag_id, int pos_type, string sub1_name, string sub1_icon, int sub2_pos, string sub2_name, string sub2_icon, int sort, string name, string icon, string desc ) 
    {
        this.id = id;
        this.tagId = tag_id;
