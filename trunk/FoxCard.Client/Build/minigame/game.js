...
const managerConfig = {
    DATA_FILE_MD5: '9c92e3aa07db2bb4',
    CODE_FILE_MD5: '2731668dc232466e',
    GAME_NAME: 'webgl',
    APPID: 'wxf229c9b224cf0df0',
    DATA_FILE_SIZE: '12275855',
    OPT_DATA_FILE_SIZE: '$OPT_DATA_FILE_SIZE',
    DATA_CDN: 'https://gleen-test-0012.oss-cn-beijing.aliyuncs.com/FoxCard/WebGL',
    // 资源包是否作为小游戏分包加载
        ...
        Object.assign(managerConfig, {
            ...
            loadingPageConfig: {
                ...
                materialConfig: {
                    ...
                    backgroundImage: 'images/bg_fox.png',
                    backgroundVideo: '',
